...
% Define the vertices and faces for a block
% vertices = [
%     0, 0, 0;  % Vertex 1
%     1.5, 0, 0;  % Vertex 2
%     1.5, 1.5, 0;  % Vertex 3
...
% end
% 
% setOccupancy(map,p1,1)
% setOccupancy(map,p2,1)
% setOccupancy(map,p3,1)
% setOccupancy(map,p4,1)
% setOccupancy(map,p5,1)
% setOccupancy(map,p6,1)
% setOccupancy(map,p7,1)
% hold on
% % Set viewpoint
% view(3);
% 
...
%             C3 = 2*rand(varSize);
  ...
  t=1;          
    ...
    /(getOccupancy(map,reptile(j).Itertn(i).crocodile.Position)+eps) % reduce function
          
 %------------------------------------------------------------------------------       
  P = Alpha + (getOccupancy(map,robots(j).Itertn(i).Pose(1,:))) - ...
          mean(getOccupancy(map,robots(j).Itertn(i).Pose(1,:))) /...
   ((getOccupancy(map,reptile(j).Itertn(i).crocodile.Position)+eps)) % percentage difference
