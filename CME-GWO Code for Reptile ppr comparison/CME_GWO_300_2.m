...
p1 = [11,17]; p2 =[2,2]; p3 =[15,15]; p4=[18,17]; p5=[12,11]; p6=[2,7]; p7=[7,12];

positions = [p1; p2; p3; p4; p5;p6;p7];



positions_ = [11, 17, 0; 2, 2, 0; 15,15,0 ;18, 17,0; 12,11,0; 2 ,7,0; 7,12,0];  % Adjust positions as needed
...
for i = 1:num_blocks
    ...
    patch('Vertices', vertices + repmat(positions_(i, :), 8, 1), 'Faces', faces, 'FaceColor', 'g', 'EdgeColor', 'k');
    hold on;
