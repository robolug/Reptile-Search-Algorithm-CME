...
wolf_empty.Itertn.leader.Position = [];
wolf_empty.Itertn.leader.Cost = [];
wolf_empty.Itertn.leader.Index = [];

 wolf_empty.Itertn.leader2.Position = [];
 wolf_empty.Itertn.leader2.Cost = [];
 wolf_empty.Itertn.leader2.Index = [];
 
 wolf_empty.Itertn.leader3.Position = [];
 wolf_empty.Itertn.leader3.Cost = [];
 wolf_empty.Itertn.leader3.Index = [];
