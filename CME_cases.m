...
for row = 2:bound-2
    for column = 2:bound-2
        if row == 5 && column == 16 
            Utility_covered;
        elseif row == 6 && (column == 15 || column == 16 || column == 17)
            Utility_covered;
        elseif row == 7 && (column == 15 || column == 16 || column == 17 || column == 14 || column == 13 || column == 12 || column == 11 ...
                || column == 10 || column == 9)
            Utility_covered;
        elseif row == 8 && (column == 15 || column == 16 || column == 17 || column == 8 || column == 9 || column == 10 || column == 11 ...
                || column == 12 || column == 13 || column == 14 )
            Utility_covered;
        elseif row == 9 && (column == 15 || column == 16 || column == 17 || column == 14 || column == 13 || column == 12 || column == 11 ...
                || column == 10 || column == 9 || column == 8)
            Utility_covered;
        elseif row == 10 && (column == 15 || column == 16 || column == 17 || column == 8 || column == 9 || column == 10)
            Utility_covered;
        elseif row == 11 && (column == 15 || column == 16 || column == 17 || column == 10 || column == 9 || column == 8 || column == 7 ...
                || column == 6 || column == 5)
            Utility_covered;
        elseif row == 12 && (column == 15 || column == 16 || column == 17 || column == 10 || column == 9 || column == 8 || column == 7 ...
                || column == 6 || column == 5 || column == 4)
            Utility_covered;
        elseif row == 13 && (column == 15 || column == 16 || column == 17 || column == 9 || column == 8 || column == 7 ...
                || column == 6 || column == 5)
            Utility_covered;
        elseif row == 14 && (column == 15 || column == 16 || column == 17 )
            Utility_covered;
        elseif row == 15 && (column == 15 || column == 16 || column == 17 )
            Utility_covered;
        elseif row == 16 && (column == 16)
            Utility_covered;
