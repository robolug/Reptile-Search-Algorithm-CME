...
for row = 2:bound-2
    for column = 2:bound-2
        ...
        if row == 3 && (column == 13)
            Utility_covered;
        elseif row == 4 && (column == 12 || column == 13 || column == 14)
            Utility_covered;
        elseif row == 5 && (column == 13 || column == 14 || column == 15 || column == 5 || column == 6)
            Utility_covered;
        elseif row == 6 && (column == 14 || column == 15 || column == 16 || column == 5 || column == 6 || column == 7)
            Utility_covered;
        elseif row == 7 && (column == 8 || column == 6 || column == 7 || column == 15 || column == 16 || column == 17)
            Utility_covered;
        elseif row == 8 && (column == 8 || column == 7 || column == 9 || column == 16)
            Utility_covered;
        elseif row == 9 && (column == 8 || column == 9 || column == 10)
            Utility_covered;
        elseif row == 10 && (column == 9 || column == 11 || column == 10)
            Utility_covered;
        elseif row == 11 && (column == 4 || column == 10 || column == 11 || column == 12)
            Utility_covered;
        elseif row == 12 && (column == 3 || column == 4 || column == 5 || column == 11 || column == 12 || column == 13)
            Utility_covered;
        elseif row == 13 && (column == 4 || column == 5 || column == 6 || column == 12 || column == 13 || column == 14)
            Utility_covered;
        elseif row == 14 && (column == 5 || column == 6 || column == 7 || column == 13 || column == 14 || column == 15)
            Utility_covered;
        elseif row == 15 && (column == 6 || column == 7 || column == 8 || column == 14 || column == 15 || column == 16)
            Utility_covered;
        elseif row == 16 && (column == 7 || column == 8 || column == 9 || column == 17 || column == 15 || column == 16)
            Utility_covered;
        elseif row == 17 && (column == 16 || column == 17 || column == 8)
            Utility_covered;    
